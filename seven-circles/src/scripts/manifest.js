...
const Scripts = ScriptBook.Import(ChocolateHell,DeadHell,GraveHell,HatHell,PaintHell,RiverHell,SwitchHell,TunnelsOfHell,VoidHell,ErrorPlace,HelloWorld,Preload,BombTest,NpcClTest);
